...
fun main() {
    ...
    val expressionLine = "2+4+222/111*30/5*5-6*86/2*94+2*3+5+8/12*3"
    val result = evaluator.evaluate(expressionLine)
    println("expression line $expressionLine result = $result")
}
    /*println("Enter line")
    val line = readLine()
